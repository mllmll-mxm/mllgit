...
public class CacheClient {
     ...
     *设置key值，和过期时间
     */
    public void setWithEx(String key,String value,int ex){
        redisTemplate.opsForValue().set(key,value,(long)ex,TimeUnit.MINUTES);
        //expire(key,(long) ex,TimeUnit.MINUTES);
    }
    ...
    public Object hGet(String key, String field) {
        ...
        if (key==null){
            System.out.println("从redis中取token：key为空");
        }
        if (field==null){
            System.out.println("从redis中取token：field为空");
        }
        return null;
    }
